...
#need to turn date into an actual date so can sort by it? 
...
new<-
  new %>% 
  filter(Event %in% c("PNEU", "BLOAT", "NAVEL", "COMMENT", "SCOURS", "DIED"))
...
#need to be dates so that recognized as such and can sort appropriately!
dvc_all <- dvc_all %>%
  mutate(
    Date = mdy(Date))
...
dvcnew_wide<-
  dvc_wide %>% 
  select(
    ID, EID, Date_PNEU1, Remark_PNEU1, Date_PNEU2, Remark_PNEU2, Date_PNEU3, Remark_PNEU3, Date_SCOURS1, Remark_SCOURS1, Date_SCOURS2, Remark_SCOURS2, Date_BLOAT1, Remark_BLOAT1, Date_BLOAT2, Remark_BLOAT2, Date_NAVEL1, Remark_NAVEL1, Date_NAVEL2, Remark_NAVEL2, Date_NAVEL3, Remark_NAVEL3, Date_DIED1, Remark_DIED1
  )
```
...
dvcnew2_wide<-
  dvc2_wide %>% 
  select(
    ID, EID, Date_PNEU1, Remark_PNEU1, Date_PNEU2, Remark_PNEU2, Date_PNEU3, Remark_PNEU3, Date_SCOURS1, Remark_SCOURS1, Date_SCOURS2, Remark_SCOURS2, Date_BLOAT1, Remark_BLOAT1, Date_BLOAT2, Remark_BLOAT2, Date_NAVEL1, Remark_NAVEL1, Date_NAVEL2, Remark_NAVEL2, Date_DIED1, Remark_DIED1)
```
