...
FINAL_Analysis <- FINAL7_new %>% 
  select(ID, sex, Breed2, stp, BRTHW, SORCE, SD, DB, diaload, diaARR, LOAD, transitT, PN1a, PN2a, DIA1, D30, P30, P60, D30yn, D60yn, diaex, navelex, DIA30, PNEU30, PNEU60, Nav30, N30, DED30, DED60, Remark_PNEU1, Remark_DIED1)
...
dia30_model <- coxph(Surv(DIA30, D30) ~ SD*DB + sex + transitT + diaARR + BRTHW, 
                   data = FINAL_Analysis_filt)
summary(dia30_model)
Anova(dia30_model, type = "III", test.statistic = "LR")
...
dia30_model <- coxph(Surv(DIA30, D30) ~ as.factor(SD) + diaARR + BRTHW, 
                   data = FINAL_Analysis_filt_d)
summary(dia30_model)
...
nav30_model <- coxph(Surv(Nav30, N30) ~ SD*DB + sex + transitT + diaARR + BRTHW, 
                   data = FINAL_Analysis_filt_n)
summary(nav30_model)
Anova(nav30_model, type = "III", test.statistic = "LR")
...
resp60_model <- coxph(Surv(PNEU60, P60) ~ SD*DB + sex + transitT + diaARR + BRTHW, 
                   data = FINAL_Analysis)
summary(resp60_model)
Anova(resp60_model, type = "III", test.statistic = "LR")
...
resp60_model <- coxph(Surv(PNEU60, P60) ~ as.factor(SD) + diaARR + BRTHW, 
                   data = FINAL_Analysis_d)
summary(resp60_model)
...
resp60_model <- coxph(Surv(PNEU60, P60) ~ SD + diaARR + BRTHW, 
                   data = FINAL_Analysis_b)
summary(resp60_model)
...
dead30_model <- coxph(Surv(DED60, D30yn) ~ SD*DB + sex + diaARR + BRTHW, 
                   data = FINAL_Analysis)
summary(dead30_model)
Anova(dead30_model, type = "III", test.statistic = "LR")
...
dead30_model <- coxph(Surv(DED60, D30yn) ~ SD + diaARR + BRTHW, 
                   data = FINAL_Analysis_d)
summary(dead30_model)
...
dead30_model <- coxph(Surv(DED60, D30yn) ~ SD + diaARR + transitT + BRTHW, 
                   data = FINAL_Analysis_b)
summary(dead30_model)
...
dead60_model <- coxph(Surv(DED60, D60yn) ~ SD*DB + sex + diaARR + transitT + BRTHW, 
                   data = FINAL_Analysis)
summary(dead60_model)
Anova(dead60_model, type = "III", test.statistic = "LR")
...
dead60_model <- coxph(Surv(DED60, D60yn) ~ SD + diaARR + BRTHW, 
                   data = FINAL_Analysis_d)
summary(dead60_model)
