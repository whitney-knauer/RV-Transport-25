...
FINAL7_new <- FINAL_new %>% 
  mutate(
    Date_PN2a = case_when(
      PN2a == 1 & dbtwP12 <7 ~ FINAL_new$Date_PNEU3, 
      PN2a == 1 & dbtwP12 >= 7 ~ FINAL_new$Date_PNEU2))
...
FINAL14_new <- FINAL_new %>% 
  mutate(
    Date_PN2a = case_when(
      PN2a == 1 & dbtwP12 <14 ~ FINAL_new$Date_PNEU3, 
      PN2a == 1 & dbtwP12 >= 14 ~ FINAL_new$Date_PNEU2))
